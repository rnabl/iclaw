    ...
    <Layout>
      <div className="legal">
        <div className="container-narrow">
          ...
          <p>
            These Terms of Service ("Terms") govern your use of iClaw, an iMessage-based 
            AI assistant service. By using iClaw, you agree to these Terms.
          </p>

          <h2>1. Service Description</h2>
          <p>
            iClaw is an AI-powered assistant accessible via iMessage. The service allows 
          ...
          <h2>2. Eligibility</h2>
          <p>
            You must be at least 13 years old to use iClaw. By using the service, you 
          ...
          <ul>
            ...
            <li>You must not share access to your iClaw account with others.</li>
          </ul>

          <h2>4. Acceptable Use</h2>
          <p>You agree not to use iClaw to:</p>
          <ul>
          ...
          <p>
            iClaw integrates with third-party services (Google, etc.) to provide 
          ...
          <p>
            iClaw uses artificial intelligence to generate responses and perform tasks. 
            While we strive for accuracy, AI responses may sometimes be incorrect or 
            incomplete. You should verify important information independently. iClaw 
          ...
          <p>
            iClaw and its original content, features, and functionality are owned by 
          ...
          <p>
            iClaw is provided "as is" and "as available" without warranties of any kind, 
          ...
          <p>
            To the maximum extent permitted by law, iClaw and its operators shall not 
          ...
          <p>
            We may suspend or terminate your access to iClaw at any time, with or without 
