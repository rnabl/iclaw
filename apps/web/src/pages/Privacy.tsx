    ...
    <Layout>
      <div className="legal">
        <div className="container-narrow">
          ...
          <p>
            iClaw ("we", "our", or "us") is committed to protecting your privacy. 
            This Privacy Policy explains how we collect, use, and safeguard your 
            information when you use our iMessage-based AI assistant service.
          </p>

          <h2>Information We Collect</h2>
          <p>When you use iClaw, we collect:</p>
          <ul>
          ...
          <p>
            iClaw is not intended for use by individuals under the age of 13. 
